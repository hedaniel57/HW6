...
<body>
    <form id="form_Detail" runat="server">
...
<div>       
    ...
    <h1>Wicked Easy Recipes</h1>
        ...
        <span class="deletedData"></span><asp:Label ID="lbl_deletedData" runat="server"></asp:Label>
        <br />
        <div>
    
            <asp:FormView ID="Form_DetailView" runat="server" DataKeyNames="Id" DataSourceID="SqlDataSource1" DefaultMode="Edit">
                <EditItemTemplate>
